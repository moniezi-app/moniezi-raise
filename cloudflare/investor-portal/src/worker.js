...
<style>
:root{color-scheme:light}*{box-sizing:border-box}body{margin:0;background:#eef3f8;color:#0f172a;font-family:Inter,Arial,Helvetica,sans-serif}.wrap{width:100%;max-width:none;margin:0;padding:0}.hero{background:#071122;color:#fff;border-radius:0;padding:26px 18px;box-shadow:none}.eyebrow{color:#93c5fd;font-size:12px;letter-spacing:.18em;text-transform:uppercase;font-weight:900}.title{font-size:34px;line-height:1.04;font-weight:950;margin:10px 0}.card{background:#fff;border-top:1px solid #dbe5f0;border-bottom:1px solid #dbe5f0;border-radius:0;padding:22px 18px;margin:0;box-shadow:none}.grid{display:grid;grid-template-columns:1fr;gap:12px}.box{background:#f8fafc;border:1px solid #dbe5f0;border-radius:18px;padding:14px}.label{font-size:11px;text-transform:uppercase;letter-spacing:.12em;color:#64748b;font-weight:900}.value{font-weight:900;margin-top:5px}.notice{background:#fffbeb;border:1px solid #fde68a;border-left:6px solid #f59e0b;border-radius:18px;padding:14px;margin-top:12px}.field{display:block;width:100%;border:1px solid #cbd5e1;border-radius:16px;padding:14px;font-size:16px;font-weight:700}.check{display:flex;gap:10px;margin:12px 0;font-weight:750}.btn{width:100%;border:0;border-radius:18px;background:#2563eb;color:#fff;font-weight:950;padding:16px;font-size:16px;cursor:pointer}.btn:disabled{opacity:.5;cursor:not-allowed}.sig{font-family:Georgia,serif;font-size:26px}.footer{font-size:12px;color:#64748b;text-align:center;margin:18px}.error{background:#fee2e2;border:1px solid #fecaca;color:#991b1b;border-radius:16px;padding:14px;font-weight:800}@media(max-width:720px){.title{font-size:27px}.card,.hero{padding-left:18px;padding-right:18px;border-radius:0}}
