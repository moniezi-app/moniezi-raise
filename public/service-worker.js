...
// MONIEZI Raise V1.3: investor portal builder, static portal export, and local business/startup templates.
// The previous "no precache" change prevented the app shell from being available
// when offline at cold start.
const CACHE_VERSION = "moniezi-raise-v1-3-investor-portal-builder-2026-05-09";
